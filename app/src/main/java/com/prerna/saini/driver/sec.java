...
public class sec extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sec);      // Restore instance state
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Toast.makeText(sec.this, "verification failed", Toast.LENGTH_LONG).show();
                // [END_EXCLUDE]
            }
            ...
            public void onCodeSent(String verificationId,
                ...
                // [START_EXCLUDE]
                // Update UI
                Toast.makeText(sec.this, "code sent", Toast.LENGTH_LONG).show();
    ...
    public void onStart() {
        ...
        if(currentUser != null)
        {
            startActivity(new Intent(sec.this, exit.class));
        }
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_VERIFY_SUCCESS:
                ...
                Toast.makeText(sec.this, "verification success", Toast.LENGTH_LONG).show();
